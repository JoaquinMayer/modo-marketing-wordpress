<header class="d-flex flex-column mm-header px-lg-4 mm-h-800 pt-lg-5">
    ...
    <div class="
          ...
          mm-h-800
        ">
        <img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego.png' ?>" srcset="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego.png' ?> 1x, <?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego@2x.png' ?> 2x" alt="raquel y diego" class="img-fluid d-lg-none" />
        <img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego-desktop.png' ?>" srcset="
        <?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego-desktop.png' ?>    1x,
        <?php echo esc_url(get_template_directory_uri()) . '/assets/images/raquel-diego-desktop@2x.png' ?> 2x
        ...
        <div class="
          ...
          ">
            ...
            <img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/icon-play.png' ?>" class="mm-icon-play" srcset="
            <?php echo esc_url(get_template_directory_uri()) . '/assets/images/icon-play.png' ?> 1x, 
            <?php echo esc_url(get_template_directory_uri()) . '/assets/images/icon-play@2x.png' ?> 2x" alt="icono de play" />
        </div>
        <div id="mm-nav" class="
            bottom-0
            d-lg-flex d-none
